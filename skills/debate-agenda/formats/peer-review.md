...
- **Blind review**: reviewers must not see each other's turns in phase 2 — the moderator enforces this by scoping the `transcript_slice` for each reviewer to just the submission.
