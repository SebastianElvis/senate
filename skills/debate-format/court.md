...
| `judge` | Rules on the merits. Does not argue. Weighs both sides, decides, writes `verdict.md`. |
...
Output contract: markdown with those three sections. Written to `.senate/runs/<id>/verdict.md`.
