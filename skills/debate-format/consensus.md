...
| `arbiter` | Orchestration role. Decides when consensus is reached, writes `verdict.md`. Does not contribute content in normal phases. |
...
Output contract: markdown with those four sections. Written to `.senate/runs/<id>/verdict.md`.
