...
- **Strict no-criticism rule**: if any phase-1 reply contains critique language ("but this won't work", "the problem with X is"), the orchestrator re-prompts once with the rule restated.
