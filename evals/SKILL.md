...
`format` must be one of the six flat formats (`parliament`, `court`, `red-team`, `peer-review`, `committee`, `brainstorm`).
...
| `peer-review-doc.md` | peer-review | Blind reviewer comments + editor decision |
